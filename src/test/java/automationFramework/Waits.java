...
public class Waits {
	...
	public static Integer EXPLICIT_WAIT_2_SEC = 2;
	...
	public static void waitTillPageLoad() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(EXPLICIT_WAIT_5_SEC));
		jsExecutor = (JavascriptExecutor) driver;
		// Wait for Javascript to load
		ExpectedCondition<Boolean> jsLoad = wd -> ((JavascriptExecutor) driver)
				.executeScript("return document.readyState").toString().equals("complete");
		// Get JS is Ready
		boolean jsReady = jsExecutor.executeScript("return document.readyState").toString()
				.equals("complete");
...
//			System.out.println("JS in NOT Ready!");
	...
	public static WebElement waitUntilClickable(WebElement element) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(EXPLICIT_WAIT_2_SEC));
	...
	public static void verifyElementPresent(String elementName, WebElement el) {
		if (Waits.verifyWebElementVisibleWebElementBoolean(el)) {
			...
			fail(elementName + " is missing on page");
		}
	}

	public static void waitForElement(WebElement element, String elementName, int waitTime){
		System.out.println("waiting for "+elementName+" element to load in UI");
